...
int main(int argc, char** argv) {
    ...
    GXColor bg_colors[] = {
        {0, 0, 0, 0},      {10, 255, 255, 64}, {10, 30, 255, 255},
    ...
    u8 current_src_factor = 6;
    u8 current_dst_factor = 5;
    u8 current_bg_color = 1;
    ...
    while (1) {
        ...
        GX_SetDstAlpha(GX_ENABLE, (u8)(16 * counter) % 256);
        position.x = cos(counter);
        position.y = sin(counter);
        position.z = -6.0;
        color = (GXColor){.r = 255, .g = 0, .b = 0, .a = 0};
        ...
        position.z = -6.0;
        color = (GXColor){.r = 0, .g = 255, .b = 0, .a = 0};
        draw_quad(view, position, color);
